...
class TestServicesAndRepos(unittest.TestCase):
    def setUp(self):
        ...
        # Services
        self.book_service = BookServices(self.book_repo, self.rental_repo, self.book_validator, self.undo_service)
        self.client_service = ClientServices(self.client_repo, self.rental_repo, self.client_validator, self.undo_service)
        self.rental_service = RentalService(self.rental_repo, self.client_service, self.book_service, self.rental_validator, self.undo_service)
