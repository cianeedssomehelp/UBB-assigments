...
class UI:
    def __init__(self, book_service: BookServices, client_service: ClientServices, rental_service: RentalService):
    ...
    def add_client_ui(self):
        try:
            client_id = int(randint(2000, 3000))
                ...
                if choice == 0:
                    ...
                    while go_on:
                        ...
                        if choose == 1:
                            ...
                            raise ValueError("Invalid input! Please enter a valid option between 1 and 6!")
                elif choice == 2:
                    go_on = True
                    while go_on:
                        UI.print_Clients()
                    ...
                    while go_on:
                        ...
                        if option == 1:
                            ...
                            raise ValueError("Invalid input! Please enter a valid option between 1 and 4!")
                else:
                    print("Invalid input! Please make a choice from 0 to 3!")
            except Exception as e:
                print(e)